...
import git from "../Images/git-min.png";
    ...
    <>
      <Section id="2" bgcolor={bgcolor} color={color}>
        ...
        <Container cardcolor={cardcolor} color={color}>
          <img src={git} alt="" />
          <Text bgcolor={bgcolor} color={color} buttoncolor={buttoncolor}>
            <h2>Github Clone (Redux)</h2>
            <p>Made a simple Github clone using Redux</p>
            <p>Tech Stack : HTML, CSS, React, Redux</p>
            <a
              href="https://sagar-go.github.io/github-assignment/"
              target="_blank"
              buttoncolor={buttoncolor}
            >
              View Project
